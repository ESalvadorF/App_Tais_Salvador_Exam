...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="DesCategoria" AutoPostBack="true" CausesValidation="false" DataValueField="CodCategoria">
        </asp:DropDownList>
